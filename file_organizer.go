...
var ExtSlice = []string{"doc", "docx", "html", "jpeg", "jpg", "JPG", "pdf", "pptx", "xlsx", "zip", "mp3", "mp4", "sh", "txt", "py", "ipynb", "csv", "conf", "png", "xls", "part", "PNG", "xls", "rar", "gz", "tar.gz", "xml", "ttf", "svg", "rmd", "r", "Rmd", "bib", "c", "md", "cpp", "rs", "dat", "odt", "ref", "pem", "torrent", "log", "cap", "netxml", "plist", "sql", "apk", "psd", "rtf", "epub", "gif", "PDF"}
